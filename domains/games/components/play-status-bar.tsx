...
export function PlayStatusBar({
  ...
  return (
    <div className="sticky top-2 z-30 mb-4 flex w-full max-w-5xl items-center justify-between gap-3 rounded-full border border-white/10 bg-black/60 px-3 py-2 backdrop-blur-md">
