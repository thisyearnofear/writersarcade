    ...
    return (
        <div className="bg-gray-900 border border-gray-800 rounded-lg p-6">
            ...
            <div className="space-y-6">
                ...
                <div className="bg-gray-800/50 rounded p-4 text-sm text-gray-300 space-y-2">
                    <div className="flex justify-between">
                        <span>Platform Fee</span>
                        <span>{writerCoin.revenueDistribution.platform}%</span>
                    </div>
                    <div className="flex justify-between">
                        <span>Creator Pool</span>
                        <span>{writerCoin.revenueDistribution.creator}%</span>
                    </div>
                    <div className="flex justify-between">
                        <span>Token Burn (Deflation)</span>
                        <span>{writerCoin.revenueDistribution.burn}%</span>
                    </div>
                </div>
